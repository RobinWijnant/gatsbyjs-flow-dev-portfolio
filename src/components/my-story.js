...
const MyStory = ({ className }: Props) => (
  <Container className={className}>
    <ReadMoreReact
      text="My story started when I was 16. I created a website, from start to finish,
    ...
    <ReadMoreReact
      text="Today, not much has changed. I still delay meals for amazing web designs
        and stunning photo’s. When new projects pop up, I like to pick just the right
        tool for the job. First, I warm up with documentation about that new tool or
        framework. This foundation allows me to instantly implement features the most
        recommended way. This is how I stay on top of the contiguous, digital changes.
